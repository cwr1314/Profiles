 ...
 * by @Hyseen
 * [Panel]
 * nf_check = script-name=nf_check, title="Netflix 检测", content="请刷新", update-interval=1
 *
 * [Script]
 * nf_check = type=generic, script-path=https://raw.githubusercontent.com/chaizia/Profiles/master/MySurge/nf_check.js, argument=title=Netflix 检测
 *
...
const DEFAULT_OPTIONS = {
  title: 'Netflix 检测',
  fullContent: '完美解锁，地区：#REGION_FLAG# #REGION_NAME#',
  fullIcon: '',
  fullIconColor: '',
  fullStyle: 'good',
  onlyOriginalContent: '仅自制剧，地区：#REGION_FLAG# #REGION_NAME#',
  onlyOriginalIcon: '',
